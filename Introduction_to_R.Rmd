...
# Practice Problems   
  1. Download the psych package and load it into your workspace  
  2. Use the data() function to load the "income" dataset from the psych packages  
  3. Inspect the structure of the income dataset. How many rows and columns are there? What are the variable names and types?
