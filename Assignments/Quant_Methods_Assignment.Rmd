...
# Standard Error for women # Asssuming equal variance 
s2pool <- (var_hm*(N_hm -1) + var_hw*(N_hw -1))/(N_hm+N_hw-2)
spool <- sqrt(s2pool)
spool/sqrt(257) #to get the standard error 
```
...
sd_comb <- sqrt((s2pool/(N_hm))+(s2pool/N_hw))
